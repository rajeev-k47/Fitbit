...
@Composable
fun ActivityFragmentComposable(navController: NavController) {
...
@Composable
fun NotificationCard(notification: Notification,navController: NavController) {
    ...
    Card(
        ...
        Row (
            ...
            Column(
                ...
                Text(text = notification.description, color = lightText, fontSize = 14.sp, fontWeight = FontWeight.Bold, overflow = TextOverflow.Ellipsis, modifier = Modifier.padding(end = 10.dp))
            ...
            if(notification.redirection != ""){
                ...
                Icon(painter = painterResource(id = R.drawable.link), contentDescription = "", modifier = Modifier
                    ...
                    .clickable(
                        ...
                        navController.navigate("group/${notification.redirection}")
                    }
                    ,
                    tint = lightText
                )
